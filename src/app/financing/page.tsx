...
export const metadata: Metadata = {
  title: "Car Financing",
  description:
    "Flexible auto financing with competitive rates from Mascardi. Get pre-approved in minutes for standard, premium, or certified pre-owned vehicle loans.",
};
              ...
              <Card key={index} className="card-premium h-full">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button className="w-full mt-6" variant="outline" asChild>
                    <a href="#pre-approval">Learn More</a>
                  </Button>
                </CardContent>
              </Card>
            ))}
          ...
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">
                Tell us a bit about what you're looking for and our financing team will reach out
                with a personalized quote within 24 hours.
              </p>
            </div>
            <Card className="card-premium">
              <CardHeader>
                <CardTitle>Pre-Approval Request</CardTitle>
                <CardDescription>No obligation, no impact on your credit score.</CardDescription>
              </CardHeader>
              <CardContent>
                <LeadForm source="financing" submitLabel="Request Pre-Approval" />
              </CardContent>
            </Card>
          </div>
        </div>
